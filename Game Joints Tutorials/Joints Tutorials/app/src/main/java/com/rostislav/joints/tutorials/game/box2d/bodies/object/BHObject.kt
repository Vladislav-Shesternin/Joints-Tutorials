...
class BHObject(
    ...
    private fun getRegionByType(): TextureRegion = when (bodyType) {
        BodyType.StaticBody    -> screenBox2d.game.themeUtil.assets.H_STATIC
        BodyType.KinematicBody -> screenBox2d.game.themeUtil.assets.H_KINEMATIC
        BodyType.DynamicBody   -> screenBox2d.game.themeUtil.assets.H_DYNAMIC
    }
