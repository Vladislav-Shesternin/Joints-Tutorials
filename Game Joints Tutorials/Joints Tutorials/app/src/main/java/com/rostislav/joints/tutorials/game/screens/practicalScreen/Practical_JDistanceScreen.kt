...
import com.rostislav.joints.tutorials.game.box2d.bodiesGroup.practical.BGPractical_JDistance
...
class Practical_JDistanceScreen(override val game: LibGDXGame): AdvancedPracticalScreen(game) {

    // BodyGroup
    override val bgPractical: AbstractBGPractical = BGPractical_JDistance(this)
