...
import com.rostislav.joints.tutorials.game.box2d.bodiesGroup.practical.BGPractical_JFriction
...
class Practical_JFrictionScreen(override val game: LibGDXGame): AdvancedPracticalScreen(game) {

    // BodyGroup
    override val bgPractical: AbstractBGPractical = BGPractical_JFriction(this)
