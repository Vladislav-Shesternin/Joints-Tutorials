...
import com.rostislav.joints.tutorials.game.box2d.bodiesGroup.practical.BGPractical_JGear
...
class Practical_JGearScreen(override val game: LibGDXGame): AdvancedPracticalScreen(game) {

    // BodyGroup
    override val bgPractical: AbstractBGPractical = BGPractical_JGear(this)
