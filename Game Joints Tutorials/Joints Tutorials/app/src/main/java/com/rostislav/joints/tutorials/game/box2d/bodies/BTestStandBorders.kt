...
class BTestStandBorders(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    override val name       = "test_stand_borders"
    override val bodyDef    = BodyDef().apply {
        type = BodyDef.BodyType.StaticBody
    }
    override val fixtureDef = FixtureDef()
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.game.themeUtil.assets.BORDERS_BLUE)
}